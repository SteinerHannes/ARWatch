...
struct PagingScrollView: View {
    ...
    init<A: View>(activePageIndex: Binding<Int>, itemCount: Int, pageWidth: CGFloat,
                  tileWidth: CGFloat, tilePadding: CGFloat, @ViewBuilder content: () -> A) {
        let views = content()
    ...
    @State private var digitalCrownScrollOffset: CGFloat = -16
        ...
        GeometryReader { _ in
            ...
            .gesture( DragGesture(minimumDistance: 0, coordinateSpace: .local)
                ...
                .onEnded { value in
                    ...
                    self.dragOffset = 0
                    withAnimation(
                        .interpolatingSpring(mass: 0.1, stiffness: 10, damping: 1.5, initialVelocity: 0)
                    ) {
...
//                    get: {
//                        print("get")
//                        return self.digitalCrownScrollOffset
//                    },
//                    set: { (value) in
//                        print("value",value)
//                        let newValue = value * -1
//                        print("newCalue",newValue)
//                        self.currentScrollOffset = newValue
//                        self.digitalCrownScrollOffset = value
//                        if (Int(newValue) - 16) % 368 == 0 {
//                            let newPageIndex = self.indexPageForOffset(self.currentScrollOffset)
//                            withAnimation(
//                                .interpolatingSpring(mass: 0.1, stiffness: 10, damping: 1.5, initialVelocity: 0)
//                            ) {
//                                self.activePageIndex = newPageIndex
//                                print(self.activePageIndex)
//                            }
//                        }
//                    }),
//                from: CGFloat(-16),
